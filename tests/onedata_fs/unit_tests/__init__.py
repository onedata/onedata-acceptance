...
CONTAINER_TEST_CFG_FILE = os.path.join(CONTAINER_UNIT_TESTS_DIR, "test_cfg.yaml")
CONTAINER_REPORTS_XML_DIR = os.path.join(CONTAINER_UNIT_TESTS_DIR, "reports/xml")
