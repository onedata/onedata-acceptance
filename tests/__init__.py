...
ACCEPTANCE_TEST_CONFIG = os.path.join(ACCEPTANCE_DIR, 'test_config.yaml')
...
ACCEPTANCE_SCENARIO_DIR = os.path.join(ACCEPTANCE_ENV_DIR, 'scenarios')
ACCEPTANCE_LANDSCAPE_DIR = os.path.join(ACCEPTANCE_ENV_DIR, 'patches')
GUI_ENV_DIR = os.path.join(GUI_DIR, 'environments')
MIXED_SWAGGERS_ENV_DIR = os.path.join(MIXED_SWAGGERS_DIR, 'environments')
