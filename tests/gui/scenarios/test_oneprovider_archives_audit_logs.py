"""This module contains tests suite for operations on archives
audit logs using Oneprovider GUI and single browser instance.
"""
...
scenarios("../features/oneprovider/data/audit_log_hashes.feature")
