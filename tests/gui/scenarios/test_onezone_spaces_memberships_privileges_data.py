"""This module contains tests suite for spaces memberships data privileges
...
scenarios("../features/onezone/space/spaces_memberships_space_privileges.feature")
scenarios("../features/onezone/space/spaces_memberships_support_privileges.feature")
