"""This module contains tests suite for operations on different storages in
Onepanel GUI and single browser instance.
"""
...
from tests.gui.meta_steps.rest.s3 import *
