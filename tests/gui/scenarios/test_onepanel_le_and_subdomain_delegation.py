"""This module contains tests suite for cluster management with Lets Encrypt and
Subdomain Delegation enabled in Onepanel GUI.
"""
...
from tests.gui.meta_steps.rest.provider import *
...
scenarios("../features/onepanel/le_in_deployed_op.feature")
