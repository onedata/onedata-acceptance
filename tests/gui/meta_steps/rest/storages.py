...
def get_storage_ids_by_name(
    ...
    storage_ids = get_storages_ids(provider_hostname, onepanel_username, onepanel_password)
    selected_ids = []
...
def restore_config_and_remove_storage_by_id(
    ...
    """
    if storage_id not in get_storages_ids(provider_hostname, onepanel_username, onepanel_password):
        return
