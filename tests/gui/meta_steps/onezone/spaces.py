...
from tests.gui.steps.onezone.marketplace import \
    assert_organization_name_in_marketplace, \
...
def _configure_space_manually(browser_id, config, selenium, oz_page, popups):
    ...
    #             add_tag_in_space_configuration_tab(selenium, browser_id, oz_page, popups ,"general", tag)

    # if tags['domains']:
    #     for tag in tags['domains']:
    #         add_tag_in_space_configuration_tab(selenium, browser_id, oz_page,"domain",tag)


@wt(parsers.parse('user of browser sees advertised space on Space Marketplace '
...
def _assert_space_in_marketplace_with_config(browser_id, config, selenium,
    ...
    assert_organization_name_in_marketplace(selenium, browser_id, oz_page,
