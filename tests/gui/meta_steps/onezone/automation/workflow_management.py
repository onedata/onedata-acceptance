...
@given(parsers.parse('user of {browser_id} uploads "{workflow}" workflow from '
                     'automation-examples repository to "{inventory}" inventory'))
def given_upload_workflow_from_automation_examples(selenium, browser_id,
                                                   oz_page, modals, inventory,
                                                   workflow, tmp_memory):
    upload_workflow_from_automation_examples(selenium, browser_id, oz_page,
                                             modals, inventory, workflow,
                                             tmp_memory)
