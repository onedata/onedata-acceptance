...
def wt_click_on_user_account_btn_panel(selenium: Any, browser_id: Any) -> Any:
    sleep(1)
...
def wt_type_password_of_user_to_curr_passwd(
    selenium: Any, browser_id: Any, user: Any, users: Any
) -> Any:
...
@repeat_failed(timeout=WAIT_FRONTEND)
def wt_click_confirm_btn_in_chpasswd_form(selenium: Any, browser_id: Any) -> Any:
    form = OnePage(selenium[browser_id]).content.account_management.chpasswd_form
