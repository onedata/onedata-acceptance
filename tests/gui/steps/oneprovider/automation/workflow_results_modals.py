...
@wt(
    parsers.parse(
        "user of {browser_id} sees that value of last column on chart"
...
@wt(
    parsers.parse(
        'user of {browser_id} chooses "{resolution}" resolution from'
...
@wt(
    parsers.parse(
        'user of {browser_id} opens "{option}" URL from '
