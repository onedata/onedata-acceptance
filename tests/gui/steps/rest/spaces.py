...
from tests.utils.environment_utils import Optional
...
def delete_space_with_rest(zone_hostname: str, owner_username: str, owner_password: str | None, space_id: str) -> None:
    res = http_delete(
        ip=zone_hostname,
        port=OZ_REST_PORT,
