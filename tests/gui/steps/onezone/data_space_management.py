...
@wt(parsers.parse('user of {browser_id} types "{text}" to space creation '
...
@wt(parsers.parse('user of {browser_id} expands settings dropdown for space '
...
@wt(parsers.parse('user of {browser_id} clicks on "Add storage" button in '
...
@wt(parsers.parse('user of {browser_id} clicks on provider named '
                  '"{provider}" in submenu of space named "{space}" '
...
@wt(parsers.parse('user of {browser_id} clicks on unsupport space for '
                  'provider "{provider}" in submenu of space named "{space}" '
                  'in expanded "DATA SPACE MANAGEMENT" Onezone panel'))
@repeat_failed(timeout=WAIT_BACKEND)
...
@wt(parsers.re('user of (?P<browser_id>.*) sees that list of supporting '
...
@wt(parsers.parse('user of {browser_id} sees that there is/are no supporting '
                  'provider(s) {providers_list} for space named '
