...
@repeat_failed(timeout=WAIT_FRONTEND)
def assert_element_in_space_marketplace(selenium, browser_id, oz_page,
                                        space_name, element_type, element_data):
    ...
    err_msg = f'{name_of_element}: {element} displayed in advertised space:' \
...
@repeat_failed(timeout=WAIT_FRONTEND)
def assert_elements_list_in_space_marketplace(selenium, browser_id, oz_page,
                                              space_name, element_type,
                                              elements_data_list):
    space = get_space_from_marketplace_list(selenium, browser_id, oz_page,
                                            space_name)
    name_of_element = element_type.capitalize()
