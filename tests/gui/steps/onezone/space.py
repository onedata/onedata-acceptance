...
@repeat_failed(timeout=WAIT_FRONTEND)
def type_on_create_new_space_input_on_create_new_space_page(selenium, browser_id, space_name, oz_page):
    driver = selenium[browser_id]
...
@wt(parsers.parse('user of {browser_id} presses enter on keyboard on create new space page'))
@repeat_failed(timeout=WAIT_FRONTEND)
def create_new_space_by_press_enter_on_keyboard_on_create_new_space_page(selenium, browser_id):
    driver = selenium[browser_id]
...
@repeat_failed(timeout=WAIT_FRONTEND)
def choose_space_on_spaces_on_left_sidebar_menu(selenium, browser_id, space_name, oz_page):
    driver = selenium[browser_id]
...
@repeat_failed(timeout=WAIT_FRONTEND)
def type_on_rename_space_input_on_overview_page(selenium, browser_id, space_name, oz_page):
    driver = selenium[browser_id]
...
@repeat_failed(timeout=WAIT_FRONTEND)
def rename_space_by_click_on_confirmation_buton_on_overview_page(selenium, browser_id, oz_page):
    driver = selenium[browser_id]
...
@repeat_failed(timeout=WAIT_FRONTEND)
def click_cancel_button_on_overeview_page(selenium, browser_id, oz_page):
    driver = selenium[browser_id]
...
@repeat_failed(timeout=WAIT_FRONTEND)
def assert_number_of_supporting_providers_of_space(selenium, browser_id, number, space_name, oz_page):
    driver = selenium[browser_id]
...
@repeat_failed(timeout=WAIT_FRONTEND)
def assert_check_size_of_space(selenium, browser_id, number, space_name, oz_page):
    driver = selenium[browser_id]
...
@repeat_failed(timeout=WAIT_FRONTEND)
def choose_members_on_left_sidebar_menu(selenium, browser_id, space_name, oz_page):
    driver = selenium[browser_id]
...
@repeat_failed(timeout=WAIT_FRONTEND)
def choose_overview_on_left_sidebar_menu(selenium, browser_id, space_name, oz_page):
    driver = selenium[browser_id]
...
@repeat_failed(timeout=WAIT_FRONTEND)
def assert_check_providers_list(selenium, browser_id, provider_name, oz_page):
    driver = selenium[browser_id]
    providers_list = oz_page(driver)['spaces'].providers_page.providers_list
    assert provider_name in providers_list and len(providers_list) == 1
...
@repeat_failed(timeout=WAIT_FRONTEND)
def choose_deploy_your_own_provider_tab_on_get_support_page(selenium, browser_id, oz_page):
    driver = selenium[browser_id]
...
@repeat_failed(timeout=WAIT_FRONTEND)
def choose_expose_exisiting_data_collection_tab_on_get_support_page(selenium, browser_id, oz_page):
    driver = selenium[browser_id]
...
@repeat_failed(timeout=WAIT_FRONTEND)
def assert_check_two_tokens_are_different(selenium, browser_id, oz_page, displays, clipboard, tmp_memory):
    driver = selenium[browser_id]
...
@repeat_failed(timeout=WAIT_FRONTEND)
def assert_check_copy_token_and_input_token(selenium, browser_id, oz_page, tmp_memory):
    driver = selenium[browser_id]
    first_token = tmp_memory[browser_id]['mailbox']['token']
