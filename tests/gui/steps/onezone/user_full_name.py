...
@when(parsers.parse('user of {browser_id} types "{text}" to user full name '
                    'edit box in Profile page'))
@then(parsers.parse('user of {browser_id} types "{text}" to user full name '
                    'edit box in Profile page'))
@repeat_failed(timeout=WAIT_FRONTEND)
...
@when(parsers.parse('user of {browser_id} sees that the user full name displayed '
                    'in Profile page is "{expected_full_name}"'))
@then(parsers.parse('user of {browser_id} sees that the user full name displayed '
                    'in Profile page is "{expected_full_name}"'))
@repeat_failed(timeout=WAIT_FRONTEND)
