...
class EmptyParallelBox(LabeledElement):
...
class Arguments(LabeledElement):
...
class Parameters(LabeledElement):
...
class WorkflowsPage(ListPage):
    ...
    workflow_creator = WebItem(
        ".content-atm-inventories-workflows-creator-view", cls=WorkflowCreator
    )
