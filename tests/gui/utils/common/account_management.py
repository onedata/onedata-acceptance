...
from tests.gui.utils.core.web_elements import Input, Label, NamedButton, WebItem
...
class UserAccountsForm(PageObject):
    ...
    confirm_password_change = NamedButton("button", text="Confirm password change")
...
class AccountManagementContentPage(PageObject):
    ...
    change_password = NamedButton(".btn-change-password", text="Change password")
    cancel_password_change = NamedButton(".btn-change-password", text="Cancel password change")
