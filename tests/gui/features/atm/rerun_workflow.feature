Feature: Workflow rerun tests
  ...
  Scenario: User sees lane run indicators and statuses after rerunning workflow
    ...
    And user of browser executes 1st revision of "checksum-counting-different-lambdas", using file as initial value: "file1" in "space1" space
    And user of browser awaits for status of "checksum-counting-different-lambdas" workflow to be "Active"

    And user of browser clicks "Cancel" button on "checksum-counting-different-lambdas" workflow status bar
    And user of browser awaits for status of "checksum-counting-different-lambdas" workflow to be "Cancelled"
    ...
    And user of browser awaits for status of "checksum-counting-different-lambdas" workflow to be "Finished"
