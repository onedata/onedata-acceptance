...
Scenario: User creates checksum-counting-oneclient workflow through gui and executes it
    ...
    And user of browser unchecks lambdas "Mount space" toggle
    And user of browser adds argument named "item" of "File" type
...
#    And user of browser adds argument named "algorithm" of "String" type
    ...
    And user of browser chooses "Iterated item" in target store dropdown menu in "item" argument in task creation page
