Feature: Management of invite tokens in Onezone GUI, with admin user
  ...
  Scenario: User successfully consumes harvester to space invite token until usage limit is not expired
    ...
    Then user of browser2 opens consume view for "harvester1" harvester, pastes token and consumes it
    ...
    Then user of browser2 opens consume view for "harvester2" harvester, pastes token and consumes it
    ...
    Then user of browser2 opens consume view for "harvester3" harvester, pastes token, fails to consume it and sees error message: "Consuming token failed"
  ...
  Scenario: User successfully cleans up obsolete tokens
    ...
    And user of browser1 opens consume view for "group1" group, pastes token and consumes it
