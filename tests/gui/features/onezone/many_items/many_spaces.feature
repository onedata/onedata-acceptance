Feature: Management of great number of spaces
  ...
  Scenario: User can see correct number of previously created spaces in spaces list in the sidebar
    ...
    Then user of browser can see there are 500 spaces in the spaces list in the sidebar


  Scenario: User can see that correct space is opened after refreshing page
    When using REST, user1 creates 500 spaces in "onezone" Onezone service
    And user of browser sees that "space1" has appeared on the spaces list in the sidebar
    And user of browser opens "space250" space in the spaces list in the sidebar
    And user of browser refreshes site
    And user of browser can see that opened space is "space250" in the spaces list in the sidebar


  Scenario: User can see correct number of shares created in multiple spaces in shares page
    ...
    Then user of browser can see there are 150 shares in the shares list in the sidebar
