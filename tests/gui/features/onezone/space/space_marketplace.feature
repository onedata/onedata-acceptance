...
#        description: "Example of a space advertised in a Marketplace"
  ...
  Scenario: User sees space details in space overview page
    ...
    And user of browser sees Tags: ["archival", "science", "big-data"] in space details in space overview page
    And user of browser sees Organization name: "onedata" in space details in space overview page
    And user of browser sees Description: "Example of a space advertised in a Marketplace" in space details in space overview page
    And trace