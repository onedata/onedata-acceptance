Feature: ACL basic subjects tests in Oneprovider GUI
  ...
  Scenario: User sees eligible subjects for ACL record
    ...
    Then user of browser sees that [user1, user2] are in subject list in first ACL record 
    And user of browser does not see "user3" in subject list in first ACL record 
    And user of browser selects group as subject type in first ACL record in edit permissions modal
    And user of browser sees that [group2, group3] are in subject list in first ACL record 
    And user of browser does not see "group1" in subject list in first ACL record 
