Feature: Basic files tab operations on external symlinks in file browser
  ...
  Scenario: User sees external symlink for directory after creating it
  ...
  Scenario Outline: User sees internal symlink for directory after creating it
    When user of browser creates dataset for item "dir1" in "space1"
    ...
    Scenario: User sees external symlink for file after creating it
      When user of browser creates dataset for item "dir1" in "space1"
