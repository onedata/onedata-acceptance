Feature: Jump to file using jump input in two file browsers
  ...
  Scenario: User sees file that was uploaded in another window after writing file name in jump input
    ...
    And user of browser1 sees that items named ["file_001", "file_002"] are displayed on page
    ...
    Then user of browser1 sees that item named "file_0011.txt" is not displayed on page
    And user of browser1 writes "file_0011" to jump input in file browser
    And user of browser1 sees that item named "file_0011.txt" is displayed on page


  Scenario: User jump to file that was uploaded in another window after scrolling to the bottom and writing file name in jump input
    When user of browser1 clicks "Files" of "space1" space in the sidebar
    And user of browser1 sees file browser in files tab in Oneprovider page
    And user of browser1 sees that items named ["file_001", "file_002"] are displayed on page
    And user of browser2 clicks "Files" of "space1" space in the sidebar
    ...
    And user of browser1 writes "file_0011" to jump input in file browser
    Then user of browser1 sees that item named "file_0011.txt" is displayed on page
