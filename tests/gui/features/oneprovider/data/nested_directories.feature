Feature: Basic files tab operations on nested directory structure in file browser
  ...
  Scenario: User changes directory using breadcrumbs
    ...
    And user of browser sees that current working directory displayed in breadcrumbs on file browser is space1/dir2
    And user of browser clicks and presses enter on item named "dir4" in file browser
    And user of browser sees that current working directory displayed in breadcrumbs on file browser is space1/dir2/dir4
