Feature: Basic datasets operations
  ...
  Scenario: User sees data protection tag in directory dataset modal and data protected status tag in file browser after marking its parent directory on ancestors list
    When user of browser creates dataset for item "dir2" in "space1"
    And user of browser clicks on menu for "dir2" directory in file browser
