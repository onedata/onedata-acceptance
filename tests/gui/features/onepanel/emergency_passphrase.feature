Feature: Scenarios featuring emergency passphrase to Onepanel GUI
  ...
  Background:
    ...
    And opened browser with admin logged to emergency interface of Onepanel service


  Scenario: User successfully change passphrase in emergency passphrase
    ...
    And user of browser clicks Log in to emergency interface in Onepanel login page
    ...
    And user of browser sees that he successfully logged in Oneprovider panel
