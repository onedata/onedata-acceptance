...
from tests.mixed_swaggers.onezone_client import (UserApi, SpaceCreateRequest,
                                                 SpaceApi, DefaultSpace,
                                                 SpaceInviteToken, ProviderApi)
from tests.mixed_swaggers.utils.common import login_to_oz
from tests.mixed_swaggers.utils.onezone.common import (get_user_space_with_name,
...
def request_space_support_using_rest(user, users, space_name, zone_name,
...
def assert_there_is_no_provider_for_space_in_oz_rest(user, users, zone_name,
    ...
    for provider_name in parse_seq(providers_list):
