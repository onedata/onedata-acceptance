Feature: Tests for oneclient interaction with spaces with the same name on 2 providers
  ...
  Scenario: Using different oneclients user can see proper space contents after removing one space
    ...
    And using oneclient1, user1 reads "TEST AAA" from file named "file1" in space with test alias "A" in oneprovider-1
    And using oneclient2, user1 reads "TEST AAA" from file named "file1" in space with test alias "A" in oneprovider-1
    And using oneclient3, user1 reads "TEST AAA" from file named "file1" in space with test alias "A" in oneprovider-1
  ...
  Scenario: Using different oneclients user can see proper space contents after renaming one space
    ...
    And using REST, user1 renames space with test alias "B" to "helloworld2" in "onezone" Onezone service
  ...
  Scenario Outline: Using different oneclients user can see proper space contents after modifying contents by oneclients on different providers
    ...
    Then using <client1>, user1 creates file named "file1" in space with test alias "A" in oneprovider-1
    And using <client2>, user1 writes "TEST AAA" to file named "file1" in space with test alias "A" in oneprovider-1
    And using <client2>, user1 creates file named "file1" in space with test alias "B" in oneprovider-1
    And using <client1>, user1 writes "TEST BBB" to file named "file1" in space with test alias "B" in oneprovider-1

    And using <client1>, user1 reads "TEST AAA" from file named "file1" in space with test alias "A" in oneprovider-1
    And using <client2>, user1 reads "TEST AAA" from file named "file1" in space with test alias "A" in oneprovider-1
    And using <client3>, user1 reads "TEST AAA" from file named "file1" in space with test alias "A" in oneprovider-1
    And using <client1>, user1 reads "TEST BBB" from file named "file1" in space with test alias "B" in oneprovider-1
    And using <client2>, user1 reads "TEST BBB" from file named "file1" in space with test alias "B" in oneprovider-1
    And using <client3>, user1 reads "TEST BBB" from file named "file1" in space with test alias "B" in oneprovider-1
