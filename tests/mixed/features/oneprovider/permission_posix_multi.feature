Feature: POSIX privileges multiclient tests
  ...
  Scenario Outline: User1 creates file using <client0> and user2 fails to change its permission using <client2>
    When using <client0>, user1 succeeds to create file named "file1" in "space1" in oneprovider-1
