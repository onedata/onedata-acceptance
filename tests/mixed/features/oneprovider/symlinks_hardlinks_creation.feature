Feature: Tests for creating and validating symlinks and hardlinks in GUI/REST
  ...
  Scenario: User creates hardlink using GUI and can see correct info about it using REST
  ...
  Scenario: User creates symlink using REST and can see correct info about it using GUI/REST
  ...
  Scenario: User creates symlink using GUI and can see correct info about it using REST
    When using web GUI, user of browser opens file browser for "space1" space
